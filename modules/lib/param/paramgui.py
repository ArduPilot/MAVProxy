...
class MainFrameBase ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_panelloadsave = wx.Panel( self.m_notebook1, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		...
		self.m_staticline8 = wx.StaticLine( self.m_panelloadsave, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		bSizer11.Add( self.m_staticline8, 0, wx.EXPAND |wx.ALL, 5 )
		
		self.m_staticline9 = wx.StaticLine( self.m_panelloadsave, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		bSizer11.Add( self.m_staticline9, 0, wx.EXPAND |wx.ALL, 5 )
		
		self.m_staticline10 = wx.StaticLine( self.m_panelloadsave, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		...
		self.m_staticText6 = wx.StaticText( self.m_panelloadsave, wx.ID_ANY, u"NV MEMORY AREA", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText6.Wrap( -1 )
		bSizer10.Add( self.m_staticText6, 0, wx.ALL, 5 )
		
		self.m_buttonLoad = wx.Button( self.m_panelloadsave, wx.ID_ANY, u"LOAD", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer10.Add( self.m_buttonLoad, 0, wx.ALL, 5 )
		
		self.m_staticline1 = wx.StaticLine( self.m_panelloadsave, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		bSizer10.Add( self.m_staticline1, 0, wx.EXPAND |wx.ALL, 5 )
		
		self.m_staticline2 = wx.StaticLine( self.m_panelloadsave, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		bSizer10.Add( self.m_staticline2, 0, wx.EXPAND |wx.ALL, 5 )
		
		self.m_buttonSave = wx.Button( self.m_panelloadsave, wx.ID_ANY, u"SAVE", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer10.Add( self.m_buttonSave, 0, wx.ALL, 5 )
		
		self.m_staticline131 = wx.StaticLine( self.m_panelloadsave, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		bSizer10.Add( self.m_staticline131, 0, wx.EXPAND |wx.ALL, 5 )
		
		self.m_staticline141 = wx.StaticLine( self.m_panelloadsave, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LI_HORIZONTAL )
		bSizer10.Add( self.m_staticline141, 0, wx.EXPAND |wx.ALL, 5 )
		
		self.m_buttonClear = wx.Button( self.m_panelloadsave, wx.ID_ANY, u"CLEAR", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer10.Add( self.m_buttonClear, 0, wx.ALL, 5 )
		
		bSizer12.Add( bSizer10, 1, wx.EXPAND, 5 )
		
		m_listBoxMemoryAreasChoices = []
		self.m_listBoxMemoryAreas = wx.ListBox( self.m_panelloadsave, wx.ID_ANY, wx.DefaultPosition, wx.Size( -1,-1 ), m_listBoxMemoryAreasChoices, wx.LB_ALWAYS_SB|wx.LB_SINGLE )
		self.m_listBoxMemoryAreas.SetMinSize( wx.Size( 375,200 ) )
		
		bSizer12.Add( self.m_listBoxMemoryAreas, 0, wx.ALL, 5 )
		
		fgSizer6.Add( bSizer12, 1, wx.EXPAND, 5 )
		
		self.m_panelloadsave.SetSizer( fgSizer6 )
		self.m_panelloadsave.Layout()
		fgSizer6.Fit( self.m_panelloadsave )
		self.m_notebook1.AddPage( self.m_panelloadsave, u"load / save", False )

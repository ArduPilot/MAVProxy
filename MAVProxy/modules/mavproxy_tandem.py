'''
Adding Tandem flying 
John Rusinko
October 2017


This module will share positional data with other ground stations
and allow pilots flying UAVs in tandem to see the position of 
the other pilots connected to the grond station. Hopefully
...
class TandemVehicle(object):
    '''a friendly tandem UAV'''

    def __init__(self, id, state):
        self.id = id
        self.state = state
        self.vehicle_colour = 'green'  # use plane icon for now, would like to use blue
        self.vehicle_type = 'plane'   # What other types are there?
